...
class VectorStore:
    ...
    def __init__(self, persist_directory: str = "./data/chroma"):
        ...
        logger.info("ChromaDB initialized. Collection 'documents' ready.")
    ...
    def search_ranked(
        ...
        ChromaDB returns L2 distances (lower = closer). We convert to a similarity
        score via `max(0.0, 1.0 - (distance / 2.0))` so higher always means more similar.
        NOTE: this is a similarity score, not a guarantee of relevance.
        """
